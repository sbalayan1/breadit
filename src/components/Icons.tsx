// exports the most important reused icons across the app

import { LucideProps } from "lucide-react"; // LucideProps is an icon library. we render svg elements because they take less time to load
